        ...
        <Row className='w-100'>
            ...
            <Col xs={6} md={3} lg={4} className='footer-section d-inline pt-4'>
                ...
                <div className='footer-section-button d-flex'>
                    <Nav.Link className='footer-section-icon'>
                        <img className='bar-filter bar-filter-img' src={FacebookIcon}></img>
                    </Nav.Link>
                    <Nav.Link className='footer-section-icon'>
                        <img className='bar-filter bar-filter-img' src={InstagramIcon}></img>
                    </Nav.Link>
                    <Nav.Link className='footer-section-icon'>
                        <img className='bar-filter bar-filter-img' src={YoutubeIcon}></img>
                    </Nav.Link>
                </div>
            </Col>
            <Col xs={6} md={3} lg={2} className='footer-section d-inline pt-4'>
                ...
                <Dropdown.Toggle id="dropdown-basic" className='dropdown-toggle d-flex justify-content-right'>
                    <img className='bar-filter bar-filter-img' src={WebIcon}></img>
